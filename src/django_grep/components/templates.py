...
from django_grep.contrib import get_files_from_dirs, unique_ordered
...
def get_template_directories() -> Generator[Path, Any, None]:
    from django_grep.components.plugins import pm
...
class NodeVisitor:  # pragma: no cover
    ...
    def visit_BlockNode(self, node: BlockNode, context: Context) -> None:
